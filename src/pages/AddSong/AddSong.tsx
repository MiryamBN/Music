...
const AddSongPage = (props:any) => {
  ...
  //   title:"",artist:"",length:0,price:0,genre:eGener.POP,
  // }); 
      ...
      <div className="card">
                <div className="grid p-fluid">
                    <div className="field col-12 md:col-3">
                        ...
                        <InputText id="block" keyfilter={/^[^<>*!]+$/}  onChange={(e) => {
...
<br></br>
          ...
          >
                ...
                <MenuItem key={genre} value={genre}>
                  {genre}
                    ...
                    <label htmlFor="integer">Price</label>
                        <InputText  id="integer" keyfilter="int"  onChange={(e) => {
            ...
            setNewSong({ ...newSong, length: Number(e.target.value) });
                    ...
                    <Button type="submit"  onClick={()=>{addNewSong()}}>add the song</Button>
                </div>
            </div>
